...
#define UniqueInput 100
#define UniqueShort 100
...
Shortest shor[UniqueInput];
Inputdata input[UniqueShort];

void search_cross(int Crossing_number, int UniqueInput) /* Search for exactly-matched data */
{
          int i;
          int f= -1;
...
void dist(int Crossing_number, int UniqueInput)
{
  int i;
  double distance,x,y;
...
void search_shortest_next_crossing(int Crossing_number, int UniqueShort)
{
    ...
    for (;;) {
        ...
        if (start != destination)
	  {
            ...
            */
            ...
            nextid =search_shortest_next_crossing(Crossing_number, UniqueShort); 
            currentid=search_shortest_next_crossing(Crossing_number, UniqueShort); 
